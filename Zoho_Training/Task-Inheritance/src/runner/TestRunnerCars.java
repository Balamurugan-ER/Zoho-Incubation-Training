...
import framework.*;
import framework.Car.Type;
/**
 * @author Balamurugan
 *
 */
public class TestRunnerCars {
	...
	private void testMod3()
	{
		...
		TestRunnerCars.carsWelcome(swiftObj);
		XUV xuvObj = new XUV();
		System.out.println("XUV Obj Invoking CarsWelcome()");
		TestRunnerCars.carsWelcome(xuvObj);
		Scross scrossObj = new Scross();
		System.out.println("Scross Obj Invoking CarsWelcome()");
		TestRunnerCars.carsWelcome(scrossObj);
	}
	...
	{
		Swift swiftObj = new Swift();
		TestRunnerCars.UpdatedCarsWelcome(swiftObj);
		XUV xuvObj = new XUV();
		TestRunnerCars.UpdatedCarsWelcome(xuvObj);
		Scross scrossObj = new Scross();
		TestRunnerCars.UpdatedCarsWelcome(scrossObj);
	}
	...
	{
		Swift swiftObj = new Swift();
		TestRunnerCars.SwiftWelcome(swiftObj);
		Car carObj = new Car();
	...
	public static void main(String[] args) {
		...
		TestRunnerCars obj = new TestRunnerCars();
		obj.testMod1();
		obj.testMod2();
		obj.testMod3();
		obj.testMod4();
